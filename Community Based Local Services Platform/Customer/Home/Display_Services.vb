...
Public Class Display_Services
    ...
    Private Sub Display_Services_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        serviceProviders.Add(New ServiceProvider() With {.Name = "Electrician", .Description = "Expert in electrical repairs", .Cost = "$50", .ServiceName = "Electrical Services", .Ratings = 4})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Plumber", .Description = "Experienced in plumbing works", .Cost = "$60", .ServiceName = "Plumbing Services", .Ratings = 4})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Gardener", .Description = "Provides garden maintenance services", .Cost = "$55", .ServiceName = "Gardening Services", .Ratings = 3})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Cleaner", .Description = "Offers professional cleaning services", .Cost = "$80", .ServiceName = "Cleaning Services", .Ratings = 5})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Painter", .Description = "Specializes in interior and exterior painting", .Cost = "$90", .ServiceName = "Painting Services", .Ratings = 4})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Carpenter", .Description = "Skilled in carpentry and woodworking", .Cost = "$85", .ServiceName = "Carpentry Services", .Ratings = 3})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Mover", .Description = "Offers moving and relocation services", .Cost = "$75", .ServiceName = "Moving Services", .Ratings = 4})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Tutor", .Description = "Provides tutoring services for various subjects", .Cost = "$65", .ServiceName = "Tutoring Services", .Ratings = 4})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Electrician", .Description = "Expert in electrical repairs and installation", .Cost = "$70", .ServiceName = "Electrical Services", .Ratings = 4})
        serviceProviders.Add(New ServiceProvider() With {.Name = "Plumber", .Description = "Offers plumbing solutions for households and businesses", .Cost = "$65", .ServiceName = "Plumbing Services", .Ratings = 3})
    ...
    Public Sub UpdateServices(searchCriteria As String)
        ...
        Else
            ...
            provider.ServiceName.ToLower().Contains(searchCriteria.ToLower())).ToList()
